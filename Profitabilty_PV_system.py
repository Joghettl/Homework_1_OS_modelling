...
print(
    "Net Present Value over the entire technical lifetime of the PV system is",
    round(npv_1, 2),
)
print(
    "Net Present Value from pure electricity purchase with no pv installed is",
    round(npv_2, 2),
)
print(
    "Net Present Value from pure electricity purchase with pv installed is",
    round(npv_2a, 2),
)
print(
    "Net Present Value if there is no remuneration for surplus feed-in is",
    round(npv_3, 2),
)
